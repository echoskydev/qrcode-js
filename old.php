                ...
                <tr>
                    <td valign="top" align="center" width="50%">
                        <table class="tsel" border="0">
                            <tr>
                                <td>
                                    <a name="" id="webcamimg" class="btn btn-primary" href="#" role="button" onclick="setwebcam()" align="left">
                                        Scan
                                    </a>
                                ...
                                <td>
                                    ...
                                    <a name="" id="qrimg" class="btn btn-primary" href="#" role="button" onclick="setimg()" align="right">
                                        Upload
                                    </a>
                                </td>
                            </tr>
